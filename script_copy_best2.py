...
dict['sprites']['menu']['normal diff']      = py.image.load("assets/HUD/normal difficulty.png").convert_alpha()
dict['sprites']['menu']['endless diff']     = py.image.load("assets/HUD/endless difficulty.png").convert_alpha()
dict['sprites']['menu']['button highlight'] = py.image.load("assets/HUD/Pixel Nebula Menu Choice.png").convert_alpha()
dict['sprites']['menu']['buttons']          = py.image.load("assets/HUD/Pixel Nebula Menu Buttons.png").convert_alpha()

# bg 0
bg00           = py.image.load("assets/backgrounds/backgrounds/background 0/frame 0.png").convert_alpha()
bg0            = [bg00]

# bg 1
bg10           = py.image.load("assets/backgrounds/backgrounds/background 1/frame 0.png").convert_alpha()
bg11           = py.image.load("assets/backgrounds/backgrounds/background 1/frame 1.png").convert_alpha()
bg1            = [bg10, bg11]

# bg 2
bg20           = py.image.load("assets/backgrounds/backgrounds/background 2/frame 0.png").convert_alpha()
bg21           = py.image.load("assets/backgrounds/backgrounds/background 2/frame 1.png").convert_alpha()
bg22           = py.image.load("assets/backgrounds/backgrounds/background 2/frame 2.png").convert_alpha()
bg23           = py.image.load("assets/backgrounds/backgrounds/background 2/frame 3.png").convert_alpha()
bg2            = [bg20, bg21, bg22, bg23]

# bg 3
bg30           = py.image.load("assets/backgrounds/backgrounds/background 3/frame 0.png").convert_alpha()
bg31           = py.image.load("assets/backgrounds/backgrounds/background 3/frame 1.png").convert_alpha()
bg32           = py.image.load("assets/backgrounds/backgrounds/background 3/frame 2.png").convert_alpha()
bg33           = py.image.load("assets/backgrounds/backgrounds/background 3/frame 3.png").convert_alpha()
bg34           = py.image.load("assets/backgrounds/backgrounds/background 3/frame 3.png").convert_alpha()
bg3            = [bg30, bg31, bg32, bg33, bg34]

# bg 4
bg40           = py.image.load("assets/backgrounds/backgrounds/background 4/frame 0.png").convert_alpha()
bg41           = py.image.load("assets/backgrounds/backgrounds/background 4/frame 1.png").convert_alpha()
bg42           = py.image.load("assets/backgrounds/backgrounds/background 4/frame 2.png").convert_alpha()
bg43           = py.image.load("assets/backgrounds/backgrounds/background 4/frame 3.png").convert_alpha()
bg44           = py.image.load("assets/backgrounds/backgrounds/background 4/frame 4.png").convert_alpha()
bg45           = py.image.load("assets/backgrounds/backgrounds/background 4/frame 5.png").convert_alpha()
bg46           = py.image.load("assets/backgrounds/backgrounds/background 4/frame 6.png").convert_alpha()
bg47           = py.image.load("assets/backgrounds/backgrounds/background 4/frame 7.png").convert_alpha()
bg48           = py.image.load("assets/backgrounds/backgrounds/background 4/frame 8.png").convert_alpha()
bg49           = py.image.load("assets/backgrounds/backgrounds/background 4/frame 9.png").convert_alpha()
bg4            = [bg40, bg41, bg42, bg43, bg44, bg45, bg46, bg47, bg48, bg49]

# bg 5
bg50           = py.image.load("assets/backgrounds/backgrounds/background 5/frame 0.png").convert_alpha()
bg5            = [bg50]

# bg 6
bg60           = py.image.load("assets/backgrounds/backgrounds/background 6/frame 0.png").convert_alpha()
bg6            = [bg60]

# # bg 7
bg70           = py.image.load("assets/backgrounds/backgrounds/background 7/frame 0.png").convert_alpha()
bg71           = py.image.load("assets/backgrounds/backgrounds/background 7/frame 1.png").convert_alpha()
bg72           = py.image.load("assets/backgrounds/backgrounds/background 7/frame 2.png").convert_alpha()
bg73           = py.image.load("assets/backgrounds/backgrounds/background 7/frame 3.png").convert_alpha()
bg7            = [bg70, bg71, bg72, bg73]


# bg backs
bg0_back       = py.image.load("assets/backgrounds/backgrounds/background 0/background.png").convert_alpha()
bg1_back       = py.image.load("assets/backgrounds/backgrounds/background 1/background.png").convert_alpha()
bg2_back       = py.image.load("assets/backgrounds/backgrounds/background 2/background.png").convert_alpha()
bg3_back       = py.image.load("assets/backgrounds/backgrounds/background 3/background.png").convert_alpha()
bg4_back       = py.image.load("assets/backgrounds/backgrounds/background 4/background.png").convert_alpha()
bg5_back       = py.image.load("assets/backgrounds/backgrounds/background 5/background.png").convert_alpha()
bg6_back       = py.image.load("assets/backgrounds/backgrounds/background 6/background.png").convert_alpha()
bg7_back       = py.image.load("assets/backgrounds/backgrounds/background 7/background.png").convert_alpha()

# lives
lives0         = py.image.load("assets/HUD/lives 0.png").convert_alpha()
lives1         = py.image.load("assets/HUD/lives 1.png").convert_alpha()
lives2         = py.image.load("assets/HUD/lives 2.png").convert_alpha()
lives3         = py.image.load("assets/HUD/lives 3.png").convert_alpha()

# player
player0        = py.image.load("assets/ships/ship 1.png").convert_alpha()
player1        = py.image.load("assets/ships/ship 2.png").convert_alpha()
player2        = py.image.load("assets/ships/ship 3.png").convert_alpha()
player3        = py.image.load("assets/ships/ship 4.png").convert_alpha()

# player moves left
player0_left   = py.image.load("assets/ships/ship 1 l.png").convert_alpha()
player1_left   = py.image.load("assets/ships/ship 2 l.png").convert_alpha()
player2_left   = py.image.load("assets/ships/ship 3 l.png").convert_alpha()
player3_left   = py.image.load("assets/ships/ship 4 l.png").convert_alpha()

# player moves right
player0_right  = py.image.load("assets/ships/ship 1 r.png").convert_alpha()
player1_right  = py.image.load("assets/ships/ship 2 r.png").convert_alpha()
player2_right  = py.image.load("assets/ships/ship 3 r.png").convert_alpha()
player3_right  = py.image.load("assets/ships/ship 4 r.png").convert_alpha()

# level win animations
stage_clear0   = py.image.load("assets/ships/level clear 1.png").convert_alpha()
stage_clear1   = py.image.load("assets/ships/level clear 2.png").convert_alpha()
stage_clear2   = py.image.load("assets/ships/level clear 3.png").convert_alpha()
stage_clear3   = py.image.load("assets/ships/level clear 4.png").convert_alpha()
stage_clear4   = py.image.load("assets/ships/level clear 5.png").convert_alpha()
stage_clear5   = py.image.load("assets/ships/level clear 6.png").convert_alpha()
stage_clear6   = py.image.load("assets/ships/level clear 7.png").convert_alpha()
stage_clear7   = py.image.load("assets/ships/level clear 8.png").convert_alpha()
stage_clear8   = py.image.load("assets/ships/level clear 9.png").convert_alpha()
stage_clear9   = py.image.load("assets/ships/level clear 10.png").convert_alpha()
stage_clear10  = py.image.load("assets/ships/level clear 11.png").convert_alpha()
stage_clear11  = py.image.load("assets/ships/level clear 12.png").convert_alpha()

# player bullets
player_bullet0 = py.image.load("assets/bullets/bullet 1.png").convert_alpha()
player_bullet1 = py.image.load("assets/bullets/bullet 2.png").convert_alpha()
player_bullet2 = py.image.load("assets/bullets/bullet 3.png").convert_alpha()
player_bullet3 = py.image.load("assets/bullets/bullet 4.png").convert_alpha()

# enemy 0 bullets
enemy0_bullet0 = py.image.load("assets/enemies/enemies 1/enemy 1/bullet 1.png").convert_alpha()
enemy0_bullet1 = py.image.load("assets/enemies/enemies 1/enemy 1/bullet 2.png").convert_alpha()
enemy0_bullet2 = py.image.load("assets/enemies/enemies 1/enemy 1/bullet 3.png").convert_alpha()
enemy0_bullet3 = py.image.load("assets/enemies/enemies 1/enemy 1/bullet 4.png").convert_alpha()
enemy0_bullets = [enemy0_bullet0, enemy0_bullet1, enemy0_bullet2, enemy0_bullet3]

# enemy 0 sprites
enemy0_frame0  = py.image.load("assets/enemies/enemies 1/enemy 1/enemy 1.png").convert_alpha()
enemy0_frame1  = py.image.load("assets/enemies/enemies 1/enemy 1/enemy 2.png").convert_alpha()
enemy0_frame2  = py.image.load("assets/enemies/enemies 1/enemy 1/enemy 3.png").convert_alpha()
enemy0_frame3  = py.image.load("assets/enemies/enemies 1/enemy 1/enemy 4.png").convert_alpha()
enemy0_frames  = [enemy0_frame0, enemy0_frame1, enemy0_frame2, enemy0_frame3]

# enemy 1 bullets
enemy1_bullet0 = py.image.load("assets/enemies/enemies 1/enemy 2/bullet 1.png").convert_alpha()
enemy1_bullet1 = py.image.load("assets/enemies/enemies 1/enemy 2/bullet 2.png").convert_alpha()
enemy1_bullet2 = py.image.load("assets/enemies/enemies 1/enemy 2/bullet 3.png").convert_alpha()
enemy1_bullet3 = py.image.load("assets/enemies/enemies 1/enemy 2/bullet 4.png").convert_alpha()
enemy1_bullets = [enemy1_bullet0, enemy1_bullet1, enemy1_bullet2, enemy1_bullet3]

# enemy 1 sprites
enemy1_frame0  = py.image.load("assets/enemies/enemies 1/enemy 2/enemy 1.png").convert_alpha()
enemy1_frame1  = py.image.load("assets/enemies/enemies 1/enemy 2/enemy 2.png").convert_alpha()
enemy1_frame2  = py.image.load("assets/enemies/enemies 1/enemy 2/enemy 3.png").convert_alpha()
enemy1_frame3  = py.image.load("assets/enemies/enemies 1/enemy 2/enemy 4.png").convert_alpha()
enemy1_frames  = [enemy1_frame0, enemy1_frame1, enemy1_frame2, enemy1_frame3]

# enemy 2 bullets
enemy2_bullet0 = py.image.load("assets/enemies/enemies 1/enemy 3/bullet 1.png").convert_alpha()
enemy2_bullet1 = py.image.load("assets/enemies/enemies 1/enemy 3/bullet 2.png").convert_alpha()
enemy2_bullet2 = py.image.load("assets/enemies/enemies 1/enemy 3/bullet 3.png").convert_alpha()
enemy2_bullet3 = py.image.load("assets/enemies/enemies 1/enemy 3/bullet 4.png").convert_alpha()
enemy2_bullets = [enemy2_bullet0, enemy2_bullet1, enemy2_bullet2, enemy2_bullet3]

# enemy 2 sprites
enemy2_frame0  = py.image.load("assets/enemies/enemies 1/enemy 3/enemy 1.png").convert_alpha()
enemy2_frame1  = py.image.load("assets/enemies/enemies 1/enemy 3/enemy 2.png").convert_alpha()
enemy2_frame2  = py.image.load("assets/enemies/enemies 1/enemy 3/enemy 3.png").convert_alpha()
enemy2_frame3  = py.image.load("assets/enemies/enemies 1/enemy 3/enemy 4.png").convert_alpha()
enemy2_frames  = [enemy2_frame0, enemy2_frame1, enemy2_frame2, enemy2_frame3]

# enemy 3 bullets
enemy3_bullet0 = py.image.load("assets/enemies/enemies 1/enemy 4/bullet 1.png").convert_alpha()
enemy3_bullet1 = py.image.load("assets/enemies/enemies 1/enemy 4/bullet 2.png").convert_alpha()
enemy3_bullet2 = py.image.load("assets/enemies/enemies 1/enemy 4/bullet 3.png").convert_alpha()
enemy3_bullet3 = py.image.load("assets/enemies/enemies 1/enemy 4/bullet 4.png").convert_alpha()
enemy3_bullets = [enemy3_bullet0, enemy3_bullet1, enemy3_bullet2, enemy3_bullet3]

# enemy 3 sprites
enemy3_frame0  = py.image.load("assets/enemies/enemies 1/enemy 4/enemy 1.png").convert_alpha()
enemy3_frame1  = py.image.load("assets/enemies/enemies 1/enemy 4/enemy 2.png").convert_alpha()
enemy3_frame2  = py.image.load("assets/enemies/enemies 1/enemy 4/enemy 3.png").convert_alpha()
enemy3_frame3  = py.image.load("assets/enemies/enemies 1/enemy 4/enemy 4.png").convert_alpha()
enemy3_frames  = [enemy3_frame0, enemy3_frame1, enemy3_frame2, enemy3_frame3]

# enemy 4 bullets
enemy4_bullet0 = py.image.load("assets/enemies/enemies 1/enemy 5/bullet 1.png").convert_alpha()
enemy4_bullet1 = py.image.load("assets/enemies/enemies 1/enemy 5/bullet 2.png").convert_alpha()
enemy4_bullet2 = py.image.load("assets/enemies/enemies 1/enemy 5/bullet 3.png").convert_alpha()
enemy4_bullet3 = py.image.load("assets/enemies/enemies 1/enemy 5/bullet 4.png").convert_alpha()
enemy4_bullets = [enemy4_bullet0, enemy4_bullet1, enemy4_bullet2, enemy4_bullet3]

# enemy 4 sprites
enemy4_frame0  = py.image.load("assets/enemies/enemies 1/enemy 5/enemy 1.png").convert_alpha()
enemy4_frame1  = py.image.load("assets/enemies/enemies 1/enemy 5/enemy 2.png").convert_alpha()
enemy4_frame2  = py.image.load("assets/enemies/enemies 1/enemy 5/enemy 3.png").convert_alpha()
enemy4_frame3  = py.image.load("assets/enemies/enemies 1/enemy 5/enemy 4.png").convert_alpha()
enemy4_frames  = [enemy4_frame0, enemy4_frame1, enemy4_frame2, enemy4_frame3]

# death animation frames
death_frame0   = py.image.load("assets/enemies/death frame 1.png").convert_alpha()
death_frame1   = py.image.load("assets/enemies/death frame 2.png").convert_alpha()
death_frame2   = py.image.load("assets/enemies/death frame 3.png").convert_alpha()
death_frame3   = py.image.load("assets/enemies/death frame 4.png").convert_alpha()
death_frame4   = py.image.load("assets/enemies/death frame 5.png").convert_alpha()
death_frame5   = py.image.load("assets/enemies/death frame 6.png").convert_alpha()
death_frame6   = py.image.load("assets/enemies/death frame 7.png").convert_alpha()
death_frame7   = py.image.load("assets/enemies/death frame 8.png").convert_alpha()

# power orb sprites
energy0        = py.image.load("assets/items/energy/energy 1.png").convert_alpha()
energy1        = py.image.load("assets/items/energy/energy 2.png").convert_alpha()
energy2        = py.image.load("assets/items/energy/energy 3.png").convert_alpha()
energy3        = py.image.load("assets/items/energy/energy 4.png").convert_alpha()
energy4        = py.image.load("assets/items/energy/energy 5.png").convert_alpha()
energy5        = py.image.load("assets/items/energy/energy 6.png").convert_alpha()

# map levels
map_level0     = py.image.load("assets/HUD/map level/map level 0.png").convert_alpha()
map_level1     = py.image.load("assets/HUD/map level/map level 1.png").convert_alpha()
map_level2     = py.image.load("assets/HUD/map level/map level 2.png").convert_alpha()
map_level3     = py.image.load("assets/HUD/map level/map level 3.png").convert_alpha()
map_level4     = py.image.load("assets/HUD/map level/map level 4.png").convert_alpha()
map_level5     = py.image.load("assets/HUD/map level/map level 5.png").convert_alpha()
map_level6     = py.image.load("assets/HUD/map level/map level 6.png").convert_alpha()
map_level7     = py.image.load("assets/HUD/map level/map level 7.png").convert_alpha()
map_level8     = py.image.load("assets/HUD/map level/map level 8.png").convert_alpha()
map_level9     = py.image.load("assets/HUD/map level/map level 9.png").convert_alpha()
map_level10    = py.image.load("assets/HUD/map level/map level 10.png").convert_alpha()
map_level11    = py.image.load("assets/HUD/map level/map level 11.png").convert_alpha()
map_level12    = py.image.load("assets/HUD/map level/map level 12.png").convert_alpha()
map_level13    = py.image.load("assets/HUD/map level/map level 13.png").convert_alpha()
map_level14    = py.image.load("assets/HUD/map level/map level 14.png").convert_alpha()
map_level15    = py.image.load("assets/HUD/map level/map level 15.png").convert_alpha()
map_level16    = py.image.load("assets/HUD/map level/map level 16.png").convert_alpha()
map_level17    = py.image.load("assets/HUD/map level/map level 17.png").convert_alpha()
map_level18    = py.image.load("assets/HUD/map level/map level 18.png").convert_alpha()
map_level19    = py.image.load("assets/HUD/map level/map level 19.png").convert_alpha()
map_level20    = py.image.load("assets/HUD/map level/map level 20.png").convert_alpha()
map_level21    = py.image.load("assets/HUD/map level/map level 21.png").convert_alpha()
map_level22    = py.image.load("assets/HUD/map level/map level 22.png").convert_alpha()
map_level23    = py.image.load("assets/HUD/map level/map level 23.png").convert_alpha()
map_level24    = py.image.load("assets/HUD/map level/map level 24.png").convert_alpha()
map_level25    = py.image.load("assets/HUD/map level/map level 25.png").convert_alpha()
map_level26    = py.image.load("assets/HUD/map level/map level 26.png").convert_alpha()
map_level27    = py.image.load("assets/HUD/map level/map level 27.png").convert_alpha()
map_level28    = py.image.load("assets/HUD/map level/map level 28.png").convert_alpha()
map_level29    = py.image.load("assets/HUD/map level/map level 29.png").convert_alpha()
map_level30    = py.image.load("assets/HUD/map level/map level 30.png").convert_alpha()
map_level31    = py.image.load("assets/HUD/map level/map level 31.png").convert_alpha()
map_level32    = py.image.load("assets/HUD/map level/map level 32.png").convert_alpha()
map_level33    = py.image.load("assets/HUD/map level/map level 33.png").convert_alpha()
map_level34    = py.image.load("assets/HUD/map level/map level 34.png").convert_alpha()
map_bg         = py.image.load("assets/HUD/map background.png").convert_alpha()
map_buttons    = py.image.load("assets/HUD/Pixel Nebula Map Buttons.png").convert_alpha()
